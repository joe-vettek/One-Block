...
loot03.add_entry(PoolEntryBuilder(farmersdelight.blocks.wild_potatoes, weight=6).add_count_function(1, 2))
...
loot04.add_entry(PoolEntryBuilder(farmersdelight.blocks.wild_rice, weight=6).add_count_function(1, 2))
...
loot05.add_entry(PoolEntryBuilder(farmersdelight.blocks.wild_beetroots, weight=6).add_count_function(1, 2))
loot05.add_entry(PoolEntryBuilder(farmersdelight.blocks.wild_cabbages, weight=6).add_count_function(1, 2))
...
loot07.add_entry(PoolEntryBuilder(farmersdelight.blocks.wild_tomatoes, weight=6).add_count_function(1, 2))
...
loot09.add_entry(PoolEntryBuilder(farmersdelight.blocks.wild_carrots, weight=6).add_count_function(1, 2))
loot09.add_entry(PoolEntryBuilder(farmersdelight.blocks.wild_onions, weight=6).add_count_function(1, 2))
