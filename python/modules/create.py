...
stage02.add_block(create.blocks.limestone, 10)
stage02.add_block(create.blocks.veridium, 6)
stage02.add_block(create.blocks.scoria, 5)
sub_provider.add_phase("02", stage02)


# 03
stage03 = SubPhaseTableBuilder(target=constant.STAGE_COLD.get_phase_id())
stage03.add_block(create.blocks.zinc_ore, 10)
stage03.add_block(create.blocks.veridium, 6)
sub_provider.add_phase("03", stage03)


# 04
stage04 = SubPhaseTableBuilder(target=constant.STAGE_SWAMP.get_phase_id())
stage04.add_block(create.blocks.zinc_ore, 10)
stage04.add_block(create.blocks.veridium, 6)
sub_provider.add_phase("04", stage04)


# 05
stage05 = SubPhaseTableBuilder(target=constant.STAGE_OCEAN.get_phase_id())
stage05.add_block(create.blocks.zinc_ore, 10)
stage05.add_block(create.blocks.veridium, 6)
...
# 08
stage08 = SubPhaseTableBuilder(target=constant.STAGE_HOT.get_phase_id())
stage08.add_block(create.blocks.zinc_ore, 12)
stage08.add_block(create.blocks.veridium, 6)
