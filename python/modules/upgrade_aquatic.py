...
loot04.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.river_sapling, weight=4).add_count_function(1, 2))
...
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.silk_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.branch_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.prismarine_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.prismarine_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.branch_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.star_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.moss_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.rock_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.star_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.finger_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.moss_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.petal_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.petal_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.chrome_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.pillow_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.rock_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.chrome_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.acan_coral, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.acan_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.pillow_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.finger_coral_fan, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(upgrade_aquatic.blocks.silk_coral_fan, weight=6).add_count_function(2, 4))
