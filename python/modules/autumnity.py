...
loot_forest_pool_sapling.add_entry(PoolEntryBuilder(autumnity.blocks.maple_sapling, weight=4).add_count_function(1, 2))
loot_forest_pool_sapling.add_entry(PoolEntryBuilder(autumnity.blocks.maple_sapling, weight=4).add_count_function(1, 2))
loot_forest_pool_sapling.add_entry(PoolEntryBuilder(autumnity.blocks.maple_sapling, weight=4).add_count_function(1, 2))
loot_forest.add_pool(loot_forest_pool_sapling)
loot_forest_pool_flower = LootPoolBuilder(CountBuilder(0, 1))
loot_forest_pool_flower.add_entry(PoolEntryBuilder(autumnity.blocks.autumn_crocus, weight=4).add_count_function(1, 2))
loot_forest_pool_flower.add_entry(PoolEntryBuilder(autumnity.blocks.foul_berries, weight=4).add_count_function(1, 2))
