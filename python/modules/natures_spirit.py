...
loot03.add_entry(PoolEntryBuilder(natures_spirit.blocks.fir_sapling, weight=4).add_count_function(1, 2))
loot03.add_entry(PoolEntryBuilder(natures_spirit.blocks.redwood_sapling, weight=4).add_count_function(1, 2))
loot03.add_entry(PoolEntryBuilder(natures_spirit.blocks.frigid_grass, weight=3).add_count_function(1, 1))
loot03.add_entry(PoolEntryBuilder(natures_spirit.blocks.cedar_sapling, weight=4).add_count_function(1, 2))
...
loot04.add_entry(PoolEntryBuilder(natures_spirit.blocks.willow_sapling, weight=4).add_count_function(1, 2))
loot04.add_entry(PoolEntryBuilder(natures_spirit.blocks.white_wisteria_sapling, weight=4).add_count_function(1, 2))
loot04.add_entry(PoolEntryBuilder(natures_spirit.blocks.blue_wisteria_sapling, weight=3).add_count_function(1, 1))
loot04.add_entry(PoolEntryBuilder(natures_spirit.blocks.pink_wisteria_sapling, weight=4).add_count_function(1, 2))
loot04.add_entry(PoolEntryBuilder(natures_spirit.blocks.purple_wisteria_sapling, weight=4).add_count_function(1, 2))
loot04.add_entry(PoolEntryBuilder(natures_spirit.blocks.helvola_pad, weight=4).add_count_function(1, 2))
loot04.add_entry(PoolEntryBuilder(natures_spirit.blocks.lotus_flower, weight=4).add_count_function(1, 2))
loot04.add_entry(PoolEntryBuilder(natures_spirit.blocks.lotus_stem, weight=4).add_count_function(1, 2))
...
loot05.add_entry(PoolEntryBuilder(natures_spirit.blocks.coconut_sprout, weight=6).add_count_function(2, 4))
loot05.add_entry(PoolEntryBuilder(natures_spirit.blocks.mahogany_sapling, weight=6).add_count_function(2, 4))
...
loot07.add_entry(PoolEntryBuilder(natures_spirit.blocks.marigold, weight=6).add_count_function(2, 4))
loot07.add_entry(PoolEntryBuilder(natures_spirit.blocks.red_maple_sapling, weight=6).add_count_function(2, 4))
loot07.add_entry(PoolEntryBuilder(natures_spirit.blocks.saxaul_sapling, weight=6).add_count_function(2, 4))
loot07.add_entry(PoolEntryBuilder(natures_spirit.blocks.aspen_sapling, weight=6).add_count_function(2, 4))
loot07.add_entry(PoolEntryBuilder(natures_spirit.blocks.ghaf_sapling, weight=6).add_count_function(2, 4))
loot07.add_entry(PoolEntryBuilder(natures_spirit.blocks.orange_maple_sapling, weight=6).add_count_function(2, 4))
loot07.add_entry(PoolEntryBuilder(natures_spirit.blocks.yellow_maple_sapling, weight=6).add_count_function(2, 4))
loot07.add_entry(PoolEntryBuilder(natures_spirit.blocks.palo_verde_sapling, weight=6).add_count_function(2, 4))
loot07.add_entry(PoolEntryBuilder(natures_spirit.blocks.joshua_sapling, weight=6).add_count_function(2, 4))
...
loot10.add_entry(PoolEntryBuilder(natures_spirit.blocks.sugi_sapling, weight=6).add_count_function(2, 4))
...
loot11.add_entry(PoolEntryBuilder(natures_spirit.blocks.olive_sapling, weight=6).add_count_function(2, 4))
loot11.add_entry(PoolEntryBuilder(natures_spirit.blocks.cypress_sapling, weight=6).add_count_function(2, 4))
loot11.add_entry(PoolEntryBuilder(natures_spirit.blocks.larch_sapling, weight=6).add_count_function(2, 4))
