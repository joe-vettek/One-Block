...
loot10.add_entry(PoolEntryBuilder(bakery.blocks.strawberry_seeds, weight=6).add_count_function(1, 2))
loot10.add_entry(PoolEntryBuilder(bakery.blocks.oat_seeds, weight=6).add_count_function(1, 2))
