...
loot09.add_entry(PoolEntryBuilder(candlelight.blocks.tomato_seeds, weight=6).add_count_function(1, 2))
...
loot10.add_entry(PoolEntryBuilder(candlelight.blocks.lettuce_seeds, weight=6).add_count_function(1, 2))
